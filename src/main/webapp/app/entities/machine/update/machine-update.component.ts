...
export class MachineUpdateComponent implements OnInit {
  ...
  protected updateForm(machine: IMachine): void {
    ...
    this.urobotsSharedCollection = this.urobotService.addUrobotToCollectionIfMissing(this.urobotsSharedCollection, machine.urobot);
  }
  ...
  protected loadRelationshipsOptions(): void {
    this.urobotService
      ...
      .pipe(map((urobots: IUrobot[]) => this.urobotService.addUrobotToCollectionIfMissing(urobots, this.editForm.get('urobot')!.value)))
